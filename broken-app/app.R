...
server <- function(input, output){
  ...
  output$penguins_text_output <- renderText({
    ...
    if(input$img_input == "All penguins"){
      ...
      message("Printing chinstrap penguin text")
